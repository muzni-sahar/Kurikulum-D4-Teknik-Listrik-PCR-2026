...
.o3{width:600px;height:500px;top:40%;left:60%;background:radial-gradient(circle,rgba(24,120,224,.04) 0%,transparent 65%);animation:f3 18s ease-in-out infinite alternate}
