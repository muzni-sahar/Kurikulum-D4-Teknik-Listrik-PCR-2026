[index.html](https://github.com/user-attachments/files/26968765/index.html)
<html lang="id">
<head>
<meta charset="UTF-8">
...
.ctxt{font-size:12px;font-weight:500;color:var(--white);display:block}
